...
class UsersSeeder extends Seeder {
    ...
    public function run()
    {
        ...
        $users = array(
            ...
            ['id' => 2, 'name' => 'Mensur', 'email' => 'mensur@mensur.com', 'password' => '$2y$10$kpkDskWOWuvBYbPI8pD46ORpcoC4.bRZFUM0m4uMI4zOFIINxyQFK', 'remember_token' => '', 'created_at' => new DateTime, 'updated_at' => new DateTime],
