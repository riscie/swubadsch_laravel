...
<body class="main">
					...
					@else
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
								@if(Auth::user()->avatar)
									<img class="avatar-frame-navbar" width="30" src="{{ asset('/avatarImages/'.Auth::user()->avatar->filename) }}"> {{ Auth::user()->name }} <span class="caret"></span></a>
								@else
									<img class="avatar-frame-navbar" width="30" src="{{ asset('/avatarImages/unknown.jpg') }}"> {{ Auth::user()->name }} <span class="caret"></span></a>
								@endif
    ...
    <script src="{{ asset('/scripts/fileinput.min.js') }}"></script>
</body>
</html>
